...
var Player = function (playlist) {
  ...
  playlist.forEach(function (play) {
    ...
    div.innerHTML =
      "<span>" + (playlist.indexOf(play) * 1 + 1) + ".</span>" + play.title;
    div.onclick = function () {
      player.skipTo(playlist.indexOf(play));
    };
  ...
  play: function (index) {
    ...
    if (data.howl) {
      ...
      sound = data.howl = new Howl({
        src: [
          "https://zingmp3.vn/bai-hat/Falling-In-Love-2NE1/ZW67WAEB.html#video-clip",
        ],
